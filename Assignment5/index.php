...
<html>
  ...
  <body style= "background-color:white;">
     <h1 align="center"> Welcome to Solr </h1><br/>
   <div align="center">
    <img src="solr-logo.jpeg" width="150" height="75" alt="Solr"/>
    <br/>
    <br/>
    <form accept-charset="utf-8" method="get" id="searchform" align="center">
      Search: <input id="q" name="q" maxlength="2048" type="text" value="<?php echo htmlspecialchars($query, ENT_QUOTES, 'utf-8'); ?>" list="searchresults" placeholder="Search the Solr or Type URL " autocomplete="off"/>
    ...
    <script>
   $(function() {
     var URL_PREFIX = "http://localhost:8983/solr/mercurynews/suggest?q=";
...
<?php
  ...
  foreach ($results->response->docs as $doc)
  {
    ...
    $id = $doc->id;
    $or_id = $id;
    $id = str_replace("/home/msd/Downloads/solr-7.5.0/mercurynews/mercurynews/","",$id);
    ...
    $html_to_text_files_dir = "/home/msd/Downloads/solr-7.5.0/mercurynews/mercurynews/";///////
